...
As I have a few WS2812 strips on top of the one RGBW ring and a few WS2812 rings the choice went towards the WS2812 to be able to mix the strip and ring.
...
PLA doesn't look that nice when sanded.
The result of heat to the above key, while not shown, was uneven and unsatisfactory an probably requires more skill to do well so that the 2 minutes spent might have turned something better up if they had been 15 minutes. 
...
The laser option looks to probsbly be the one with a higher degree of repeatability and probably a better surface finish also through sanding and painting and sanding and painting and then lasering though tape and filling in the inlay with the tape in place.
...
Maybe something like this: link:https://www.thingiverse.com/thing:4718186[^]
