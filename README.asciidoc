= kerbal-control
:author: Sean Donnellan, Oscar Donnellan, Fynn Donnellan
:toc: right
:sectnums:
:sectnumlevels: 5
:toclevels: 5
...
[source%linenums, c++]
----
include::./src/fastled-test/fastled-test.ino[]
----
...
[source%linenums, c++]
----
include::./src/button-test/button-test.ino[]
----
...
[source%linenums, c++]
----
include::./src/button-test2/button-test2.ino[]
----
...
[source%linenums, c++]
----
include::./src/kerbal-controller/kerbal-controller.ino[]
----
...
. Edit code on the host (Steamdeck) using VS Code or your preferred editor.
. Save changes locally.
. Transfer the updated code to the Raspberry Pi using `scp`:
+
----
...
----
. On the Pi, compile the code using Arduino CLI:
+
----
...
----
. Upload the compiled code to the Arduino Pro Micro:
+
----
...
[plantuml, dev-pipeline-sequence, svg]
----
include::plantuml/dev-pipeline-sequence.puml[]
----